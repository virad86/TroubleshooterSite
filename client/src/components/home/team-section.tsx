  ...
  const teamMembers = [
    {
      ...
      image: "https://api.dicebear.com/7.x/identicon/svg?seed=ViradFernando&backgroundColor=0D8ABC",
    ...
    },
    {
      ...
      image: "https://api.dicebear.com/7.x/identicon/svg?seed=RyanFernando&backgroundColor=991B1B",
      badge: "PRINCIPAL TEAM",
    ...
    },
    {
      ...
      image: "https://api.dicebear.com/7.x/identicon/svg?seed=NavindaYatawara&backgroundColor=065F46",
      badge: "PRINCIPAL TEAM",
      position: "RACE ENGINEER"
    }
  ];
